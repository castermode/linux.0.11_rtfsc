...
###############################
# breakpoint1: 0x7c00
# step1: 将512b的bootsect从0x7c00移动至0x90000
###############################
	ljmp    $BOOTSEG, $_start
_start:
...
###############################
# breakpoint4: 0x90028
# step4: 将4个扇区的setup文件load至0x90200
###############################	
load_setup:
...
###############################
# breakpoint5: 0x90042
# step5: 获取磁盘参数：通过int 0x13中断，获取每条磁道的扇区数，存储在sectors变量里
###############################	
